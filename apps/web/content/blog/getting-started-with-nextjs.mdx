...
After 25 years of building web applications, I've seen frameworks come and go. Next.js, however, has fundamentally changed how I approach building modern web applications. The introduction of the App Router in Next.js 13+ represents one of the most significant paradigm shifts I've experienced since transitioning from server-side rendering to single-page applications over a decade ago.
...
export const metadata: Metadata = {
  ...
  description: 'Learn about my 25 years of experience in software development',
  openGraph: {
    title: 'About Jason Cochran',
    description: 'Learn about my 25 years of experience in software development',
    images: ['/og-image.jpg'],
...
After 25 years of web development, I can confidently say that Next.js is one of the most significant advances in the React ecosystem. Start with these patterns, and you'll be well on your way to building production-grade applications.
