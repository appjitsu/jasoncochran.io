...
When Rook PSA hit 10 million time entries and queries started taking 30+ seconds, we had to get serious about database optimization. After 25 years of database work and optimizing queries across PostgreSQL, SQL Server, MySQL, and MongoDB, here are the techniques that made the biggest impact.
...
After applying these optimizations to Rook PSA:
...
After 25 years of database work, I've learned that most performance problems come from missing indexes or N+1 queries. Fix those, and you're 90% of the way there.
